...
public class Quiz_Form extends javax.swing.JFrame {
    ...
    String[] questions = {"Qual o nome da música tema tocada no filme Titanic - 1997?", "Qual o nome do carro com poder de viajar no tempo no filme de volta para o futuro?","De qual filme é essa frase: “Às vezes é preciso aprender a correr antes de começar a andar”?"};
    // the last item is the correct answer
    // we will check the selected answer from the user with the çast item
    String[][] options = {{"Beaty Woman","Ghost Boosters","My heart will go on","Legends of awesomeness"}, {"Toyota Corolla","Bugatti Veyron","DeLorean","Shelby Mustang"}, {"Vingadores: Ultimato (2019)","Vingadores: A Era de Ultron (2015)","Homem de Ferro (2008)","Homem de Ferro 2 (2010)"}};
