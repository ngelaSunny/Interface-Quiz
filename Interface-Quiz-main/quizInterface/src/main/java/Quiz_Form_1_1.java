 ...
 */
public class Quiz_Form_1_1 extends javax.swing.JFrame {
    
    
    
    String[] questions = {"Um garoto recebe uma carta para ir estudar em uma escola de magia e bruxaria.", "Após a morte de seu avô, um menino viaja para um lugar, e descobre verdades sobre o passado dele.","Um menino descobre que é filho de um deus, e corre perigo no meio dos mortais."};
    // the last item is the correct answer
    // we will check the selected answer from the user with the çast item
    String[][] options = {{"Harry Potter","A Culpa é das Estrelas","Os Jogos Vorazes","Percy Jackson"}, {"O Lar da Srta.Peregrine para Crianças Peculiares","O Mistério da Estrela Stardust","O Menino do Pijama Listrado","Lugar Nenhum"}, {"Percy Jakson e Os Olimpianos","Coraline","O Livro do Cemitério","Magnus Chase e os Deuses de Asgard"}};
    ...
    public void getSelectedOption(JRadioButton rbtn){
        ...
        if(rbtn.getText().equals(options[index][0]))
        {
            correct++;
        }
        index++;
